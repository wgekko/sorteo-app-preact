import { useState, useEffect, useCallback } from "preact/hooks"; // Preact import
import { Button } from './components/button';
import { Input } from './components/input';
import { Alert, AlertDescription, AlertTitle } from './components/alert';
import { AiOutlineWarning } from 'react-icons/ai'; // Cambio de importación para Preact
...
const App = () => {
    ...
    const handleApuestaQuiniInput = (index, value) => {
    ...
    const handleResultadoQuiniInput = (index, value) => {
        const num = parseInt(value, 10);
    ...
    const handleApuestaBrincoInput = (index, value) => {
        const num = parseInt(value, 10);
        if (value === "") {
    ...
    const handleResultadoBrincoInput = (index, value) => {
        const num = parseInt(value, 10);
                        ...
                        <div className="inputs-container">
                            {apuestaQuini.map((num, index) => (
                                <Input
                                    ...
                                    onInput={(e) => handleApuestaQuiniInput(index, e.target.value)}
                        ...
                        <div className="inputs-container">
                            {resultadoQuini.map((num, index) => (
                                <Input
                                    ...
                                    value={num === null ? '' : num.toString()}
                                    onInput={(e) => handleResultadoQuiniInput(index, e.target.value)}
                                    className="retro-input"
                                />
                            ))}
                        </div>
                        ...
                        <div className="inputs-container">
                            {apuestaBrinco.map((num, index) => (
                                <Input
                                    ...
                                    placeholder={`A${index + 1}`}
                                    value={num === null ? '' : num.toString()}
                                    onInput={(e) => handleApuestaBrincoInput(index, e.target.value)}
                                    className="retro-input"
                                />
                            ))}
                        </div>
                        ...
                        <div className="inputs-container">
                            {resultadoBrinco.map((num, index) => (
                                <Input
                                    ...
                                    placeholder={`R${index + 1}`}
                                    value={num === null ? '' : num.toString()}
                                    onInput={(e) => handleResultadoBrincoInput(index, e.target.value)}
                                    className="retro-input"
                                />
                            ))}
                        </div>
